...
namespace JobBoard.Infrastructure.Migrations
{
    ...
    [Migration("20250413222044_UpdateFieldsMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobBoard.Data.Entities.JobCreationLog", b =>
                {
            ...
            modelBuilder.Entity("JobBoard.Data.Entities.JobCreationLog", b =>
                {
                    b.HasOne("JobBoard.Data.Entities.JobListing", "JobListing")
                        .WithOne("JobCreationLog")
                        .HasForeignKey("JobBoard.Data.Entities.JobCreationLog", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobBoard.Data.Entities.Identity.User", "User")
                        .WithMany("jobCreationLogs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobBoard.Data.Entities.Identity.User", b =>
                {
                    ...
                    b.Navigation("jobCreationLogs");
                });

            modelBuilder.Entity("JobBoard.Data.Entities.JobListing", b =>
                {
                    b.Navigation("JobCreationLog")
                        .IsRequired();
