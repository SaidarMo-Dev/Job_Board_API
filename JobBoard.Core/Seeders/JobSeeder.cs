	...
	public static class JobSeeder
	{
		private static List<JobListing> GetJobs()
		{
			return new List<JobListing>
			{
				...
				new JobListing { Title = "Content Writer", Description = "Produce SEO-optimized content for blogs, websites, and documentation.", CompanyId = 1, Location = "Remote", JobType = JobTypeEnum.FreeLance, MinSalary = 30000, MaxSalary = 50000, ExperienceLevel = ExperienceLevelEnum.EntryLevel, DatePosted = DateTime.UtcNow.AddDays(-1), Status = JobStatusEnum.New, CreatedByUserId = 1 },
